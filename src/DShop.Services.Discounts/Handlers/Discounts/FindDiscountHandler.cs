...
{
    public class FindDiscountHandler : IQueryHandler<FindDiscounts, IEnumerable<DiscountDto>>
    {
        private readonly IMongoRepository<Discount> _discountsRepository;

        public FindDiscountHandler(IMongoRepository<Discount> discountsRepository)
        {
